class Accessory {
     ...
     */
    staticSelect({options, initialOption, actionId, placeholder = 'Pick an option'}) {
        const element = {
            accessory: {
                type: 'static_select',
     ...
     */
    conversationSelect({initialConversation, actionId, filter =['public', 'private'], placeholder = 'Select channel', excludeBotUsers = true, excludeExternalSharedChannels=true}) {
        const element = {
            accessory: {
